<?php 
    echo '<link rel="stylesheet" href="'.View::linkStamp('/css/sidebar.css').'">';
    echo '<script src="'.View::linkStamp('/js/sidebar_timer.js').'">  </script>';
?>
...
?> 
<div class="sidebar">
  <div id="mbtn-sidebar-close" style="display: none"><i class="ion-ios-arrow-left"></i><i class="ion-ios-arrow-left"></i></div>
  ...
  <li>
    ...
    <ul class="sidebar-menu-2">
      ...
      <li class="selected"><a href="/orgeducwork">Організація виховної роботи</a></li>
      <li class="selected"><a href="/section">Гурткова робота</a></li>
      <!-- <li class="selected"><a href="/uconstruct">Профспілкова організація</a></li> -->
      <li class="selected"><a href="/educwork">Наші перемоги</a></li>
      <li class="selected"><a href="/sport">Спортивні досягнення</a></li>
    </ul>
  </li>
  <li class="m-sidebar-hide">
  ...
  <li>
    <span class="hidden"><i class="fa fa-exclamation-triangle"></i>Служба охорони праці<i class="icon-down-open-big"></i></span>
    <ul class="sidebar-menu-2">
      <li class="selected"><a href="/safetyhealth/internet">Обережно – інтернет!</a></li>
      <li class="selected"><a href="/safetyhealth/mushroom">Увага, гриби!</a></li>
      <li class="selected"><a href="/safetyhealth/smoke">Тютюн – повільна отрута!</a></li>
    </ul>
  </li>
  <li>
...
<div class="coutdown-timer">
  ...
  <img src="/img/pages/_sidebar/att.jpg" alt="" style="width: 90%;">
  <div class="str-timer">До початку<br> Зовнішнього Незалежного Оцінювання</div>
  
  <div class="finest-timer" id="timer" data-deadline="05/22/2018 09:00:00"> 
   <div class="finest-timer-header">залишилося</div>
...
if (count($students)>0) {
 ...
 <img src="/img/pages/_sidebar/giphy.gif" alt="" class="birthday-foto">
 </div>
END;
  ...
  <ul>
    <li>
      <a href="http://mon.gov.ua/">
        <?php 
        echo '<img src="/img/pages/_sidebar/link-2.jpg" alt="">';
        ?>
    ...
    <li>
      <a href="http://department.osvita-dnepr.com/">
        <?php 
        echo '<img src="/img/pages/_sidebar/link-4.jpg" alt="">';
        ?>
    ...
    <li>
      <a href="http://nmc-pto.dp.ua/">
        <?php 
        echo '<img src="/img/pages/_sidebar/link-3.jpg" alt="">';
        ?>
    ...
    <li>
      <a href="http://adm.dp.gov.ua/">
        <?php 
        echo '<img src="/img/pages/_sidebar/link-1.jpg" alt="">';
        ?>
